...
module.exports = function routes(app){
  ...
  app.get('/api/stops/:agency/:route_id', function(req, res){
    console.log("gettin the stoplist");
    var agency_key = req.params.agency
      , route_id = req.params.route_id;
  ...
  //Shapes
  app.get('/api/shape/:agency/:route_id/', function(req, res){
    var agency_key = req.params.agency
      , route_id = req.params.route_id
    gtfs.getShapesByRoute(agency_key, route_id, function(e, data){
      res.send( data || {error: 'Couldn\'t get a shape.'});
    });
  });

  app.get('/api/shapeid/:agency/:route_id/', function(req, res){
    var agency_key = req.params.agency
      , route_id = req.params.route_id
    gtfs.getShapeIdsByRoute(agency_key, route_id, function(e, data){
      res.send( data || {error: 'Couldn\'t get a shape.'});
    });
  });

  app.get('/api/points/:agency/:shape_id/', function(req, res){
    var agency_key = req.params.agency
      , shape_id = req.params.shape_id
    gtfs.getShape(agency_key, shape_id, function(e, data){
      res.send( data || {error: 'Couldn\'t get a shape.'});
    });
  });

  app.get('/api/process/:agency/', function(req, res){
    var agency_key = req.params.agency;
    gtfs.processShapes(agency_key, function(e, data){
      res.send( data || {error: 'Couldn\'t process shapes.'});
    });
  });

  app.get('/api/thistime/:agency/:time/', function(req, res){
    var agency_key = req.params.agency;
    var time = req.params.time;
    gtfs.getStopsAtThisTime(agency_key, time, function(e, data){
      res.send( data || {error: 'Couldn\'t find anything that stops'});
    });
  });

  //Trips
  app.get('/api/trips/:agency/:route_id/', function(req, res){
    var agency_key = req.params.agency
      , route_id = req.params.route_id
    gtfs.getTripsByRoute(agency_key, route_id, function(e, data){
      res.send( data || {error: 'No trips for this route'});
    });
  });

  app.get('/api/alltrips/:agency/', function(req, res){
    var agency_key = req.params.agency;
    gtfs.getAllTrips(agency_key, function(e, data){
      res.send( data || {error: 'Couldn\'t get all the trips'});
    });
  });
